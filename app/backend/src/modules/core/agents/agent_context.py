...
def create_context_agent():
    return Agent(
        ...
        instructions=[
            ...
            *IMPORTANTE*: Fazer a distinção entre projetos de elétrica e segurança.
            ...
            *IMPORTANTE*: use essa categoria *SOMENTE SE* for mencionado algum dos itens acima ou a palavra *segurança* indicando que isso deve ser
